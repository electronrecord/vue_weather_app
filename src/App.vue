...
export default {
  ...
  data () {
    return {
      api_key: 'd8990acb2463bc2173eadc5c2d90d9fa',
  ...
  methods: {
    ...
    dateBuilder () {
      let d = new Date();
      let months = ["Ianuarie", "Februarie", "Martie", "Aprilie", "Mai", "Iunie", "Iulie",
       "August", "September", "Octombrie", "Noiembrie", "Decembrie"];
...
#app.rain {
 background-image: url('./assets/rein-bg.jpg');
}
